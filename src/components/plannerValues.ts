/**
 * Values Planner — the 83-value card sort, extracted VERBATIM from
 * web/public/app.html PLANNER_VALUES (script-extracted 2026-07-04; never
 * hand-retype this list — re-extract if the web source changes).
 * Source: Personal Values Card Sort — Miller, C’de Baca, Matthews &
 * Wilbourne (2001), University of New Mexico.
 */
export const PLANNER_VALUES: Array<[string, string]> = [
...
export const PLANNER_VALUE_NAMES: string[] = PLANNER_VALUES.map(v => v[0]);
